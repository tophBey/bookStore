            ...
            <div class="row">
                ...
                <div class="col-lg-6 py-5">
                    <div class="d-flex justify-between">
                        ...
                        @else
                            <p class="btn btn-warning text-light me-4 ms-5">Pending</p>
                            <form method="post" action="{{ route('dashboard.orders.update', $order) }}">
                                @csrf
                                @method('PATCH')
                                <button type="submit" class="btn btn-info px-5 text-light">Approve</button>
                            </form>
                        @endif
                ...
                <div class="col-lg-6">
                    ...
                    <a href="{{ route('dashboard.orders') }}" class="btn btn-primary mt-5 px-5">Kembali</a>
                </div>
