    ...
    <div class="col-lg-12">
        ...
        <table class="table">
            ...
            <tr >
                    ...
                    @if (!$order->is_paid)
                        <td class="px-3 py-3"><span class="badge rounded-pill text-bg-warning">Waiting</span></td>
                        @else
                        <td class="px-3 py-3"><span class="badge rounded-pill text-bg-success">Success</span></td>
                        
                    @endif
                    <td class="px-3 py-3">
                        <a href="{{ route('dashboard.myOrders.detail', $order) }}" class="btn btn-info px-4 text-light">
                            Detail
                        </a>
